...
@Slf4j
@Getter
public class CourierNotCreatedException extends RuntimeException {
    private final IMessageCodes messageCodes;

    public CourierNotCreatedException(IMessageCodes messageCodes) {
        super(MessageUtils.getMessage(messageCodes));
        this.messageCodes = messageCodes;
        log.error("[CourierNotCreatedException} -> message: {} - developer message: {}",
